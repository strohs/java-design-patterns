package patterns.behavioral.observer2;
...
// can be observed
class Observable <T> {
    //keeps a list of the current observers
...
//Person is observable, but NOTICE that Person EXTENDS Observable, could be a problem
